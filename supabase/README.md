...
└── sql/
    ...
    └── 064_drive_edge_function_service_role_grants.sql (드라이브 함수 최소 DB 권한)
```
...
| 64 | `064_drive_edge_function_service_role_grants.sql` | 비공개 파일 보기·다운로드·영구삭제 Edge Function의 최소 DB 권한 |
